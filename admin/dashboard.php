...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                ...
                <h1 class="text-light"><a href="index.html">ADGECO</a></h1>
            </div>
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#clientes"><i class="bx bx-book-content"></i>Clientes</a></li>
    ...
    <main id="main">
                ...
                <form id="form_data_about" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group col-12">
                            ...
                            <input type="text" id="img_plan" name="img_plan" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                        <div class="input-group input-group-sm col-6 ">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group col-12">
                            ...
                            <input type="text" id="img_vision" name="img_vision" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                        <div class="input-group input-group-sm col-6 ">
                            <div class="input-group-prepend">
                                <a href="https://fontawesome.com/" target="_blank" class="input-group-text  alert-primary">ICO VISION</a>
                            </div>
                            <textarea class="form-control" id="ico_vision" name="ico_vision" aria-label="With textarea"> <?php echo $ico_vision ?></textarea><br>
                        </div>
                        <div class="input-group input-group-sm col-6 ">
                            <div class="input-group-prepend">
                                <span class="input-group-text  alert-primary">TITULO VISION</span>
                            </div>
                        ...
                        <div class="input-group col-12">
                            <div class="input-group-prepend">
                                <span class="input-group-text  alert-primary">CONTENIDO VISION</span>
                            </div>
        ...
        <section id="clientes" class="clientes">
            <div class="container">
                <form id="form_data_clientes" method="post">
                    <div class="section-title">
                        <h2>CLIENTES</h2>
                    </div>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_clientes" onclick="fntDibujoClientes()">
                        REGISTROS INSERTADOS
                    </button>
                    <div class="row">
                        <div class="input-group input-group-sm col-12 ">
                        ...
                        <div class="input-group input-group-sm col-12 ">
                            ...
                            <input type="hidden" id="idClientes" name="idClientes" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                            <input type="text" id="url" name="url" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    ...
                    <button type="button" class="btn btn-success" onclick="fntInsertClientes()">
                        GUARDAR REGISTRO NUEVO
                    </button>
                    ...
                    <div class="modal fade" id="modal_clientes" tabindex="-1" role="dialog" aria-labelledby="modal_clientesLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h2 class="modal-title" id="modal_clientesLabel">TABLA CLIENTES</h2>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="dibujo_tabla_clientes_" id="dibujo_tabla_clientes_" name="dibujo_tabla_clientes_"></div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
